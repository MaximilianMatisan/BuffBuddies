...
where
    Renderer: iced_core::image::Renderer + iced_core::text::Renderer,
{
...
impl<'a, Message: 'a, Renderer> From<ShopWidget<'a, Message, Renderer>>
    for Element<'a, Message, Theme, Renderer>
where
    Message: Clone,
    Renderer: 'a + iced_core::image::Renderer + iced_core::text::Renderer,
{
